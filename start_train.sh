...
./tools/train_net.py --gpu 0 --solver models/checkcode_vgg16/solver.prototxt --weights data/imagenet_models/VGG16.v2.caffemodel --imdb checkcode_train --iters 200000
